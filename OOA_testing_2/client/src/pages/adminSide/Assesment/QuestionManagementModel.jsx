...
const QuestionManagementModal = ({ assessmentId, isOpen, onOpenChange }) => {
  ...
  // New state for all questions selection
  ...
  const handleAddQuestion = async () => {
    ...
    try {
      ...
      // Reset current question state, maintaining selected type and category
      setCurrentQuestion({
        text: "",
  ...
  // New function to add selected questions to the assessment
  const handleAddSelectedQuestions = async () => {
    ...
    try {
      ...
      setQuestions([...questions, ...addedQuestions.questions]);
  ...
  const renderFilters = () => (
    <div className="flex space-x-4 mb-4">
      ...
      <Button
        variant="outline"
        onClick={() => {
          // Reset filters and reload all questions
      ...
      <DialogContent className="max-w-4xl">
        ...
        {isLoading ? (
          ...
          <div className="max-h-[400px] overflow-y-auto pr-4">
            ...
            {/* Selected Questions Count and Add Button */}
