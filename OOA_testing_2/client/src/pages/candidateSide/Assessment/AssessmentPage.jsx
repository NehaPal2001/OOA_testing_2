...
import {
  ...
  TabSwitchWarning,
  SessionEndedCard,
} from "@/services/TabLockService";

const AssessmentPage = () => {
  const { assessmentId } = useParams();
  const [duration, setDuration] = useState(null);
  const { warnings, remainingWarnings, isSessionEnded, showWarningOverlay } =
    useTabLockService();
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6 relative">
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <div className="w-full md:w-1/3 md:sticky md:top-4 space-y-4">
              {duration && (
                <Card className="border-none shadow-lg bg-white/90 backdrop-blur">
                  <CardHeader className="border-b border-gray-100">
